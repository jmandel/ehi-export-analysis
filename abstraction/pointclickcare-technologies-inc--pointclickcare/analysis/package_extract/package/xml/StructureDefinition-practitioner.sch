...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner">
      ...
      <sch:assert test="count(f:extension[@url = 'https://ehi-export.pointclickcare.com/site/StructureDefinition-Custodian.html']) &lt;= 1">extension with URL = 'https://ehi-export.pointclickcare.com/site/StructureDefinition-Custodian.html': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://ehi-export.pointclickcare.com/site/StructureDefinition-Context.html']) &lt;= 1">extension with URL = 'https://ehi-export.pointclickcare.com/site/StructureDefinition-Context.html': maximum cardinality of 'extension' is 1</sch:assert>
